...
export default function Home() {
    return (
        <div className="relative">
            ...
            <div className="mx-auto w-full w-full text-center fade-in" data-aos="fade-up" data-aos-duration="1000">
                ...
                <div className=" flex w-[100%] flex-wrap	justify-evenly  mt-10 items-left">
                    <div class="my-5 flex-col w-[45%] rounded overflow-hidden shadow-2xl" data-aos="flip-up" data-aos-duration="500">
                    ...
                    <div class=" my-5 flex-col w-[45%] rounded overflow-hidden shadow-lg" data-aos="flip-up" data-aos-duration="1000">
                    ...
                    <div class="my-5 flex-col w-[45%] rounded overflow-hidden shadow-lg" data-aos="flip-up" data-aos-duration="1500">
                    ...
                    <div class="my-5 flex-col w-[45%] rounded overflow-hidden shadow-lg" data-aos="flip-up" data-aos-duration="2000">

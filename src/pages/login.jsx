...
function Login() {
  ...
  return (
    <div className="mx-auto flex flex-col items-center justify-center bg-gray-100">
                        <h2 className="mt-14 md:mt-0 p-3 bg-gradient-to-r from-purple-500 via-blue-500 to-purple-500 bg-clip-text text-6xl font-bold tracking-tight text-transparent" id="about">
                    OBOG
                </h2>
